...
class Exp(MyExp):
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False, args=None):
    ...
    def get_evaluator(self, batch_size, is_distributed, testdev=False, args=None):
        from yolox.evaluators import COCOEvaluator

        val_loader = self.get_eval_loader(batch_size, is_distributed, testdev=testdev, args=args)
