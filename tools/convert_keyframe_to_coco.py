...
parser = argparse.ArgumentParser(description='sampling low-rate images from high-rate images')
parser.add_argument('-d', '--data_path', help="data path", type=str, default='')
...
if __name__ == '__main__':
    ...
    for seq in sorted(seqs):
        ...
        ann_path = os.path.join(seq_path, 'gt/gt_val_half.txt')
